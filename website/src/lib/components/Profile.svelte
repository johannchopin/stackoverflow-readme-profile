<script lang="ts">
  import { HTML_CODE_TEMPLATE, MD_CODE_TEMPLATE } from "$lib/constants"
  ...
  $: mdCode = getProfileCode(MD_CODE_TEMPLATE, userId, pathToProfile)
  $: htmlCode = getProfileCode(HTML_CODE_TEMPLATE, userId, pathToProfile)
</script>
